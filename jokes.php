...
<div id="page-wrapper">
    <div id="page-inner">
        <div class="row">
            <div class="col-md-12">
                <h1 class="page-head-line"><!-- <img src="assets/img/logo.png" style="width:5%;"> --> JOKES</h1>
                ...
                <h1 class="page-subhead-line">Manage jokes responses</h1>
            </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table">
                            ...
                            <tbody>
                                <?php
                                $sql = "select * from creative where status = 1 and type = 'jokes' order by content";
                                $res=$con->query($sql);
                                if ($res->num_rows>0) {
    ...
    <div class="modal-dialog">
       <div class="modal-content">
         <div class="modal-header">
            <h4 class="modal-title">Add Jokes Responses</h4>
         </div>
          <div class="modal-body" style=" height: 150px;">
             <table style="width: 100%;">
              <input type="hidden" id="id">
               <tr>
                <td style="width: 20%">Joke</td>
...
<script type="text/javascript">
    ...
    function loadAddModal(){
        $(".modal-title").text("Add Jokes Responses");
        $("#id").val();
        $("#word").val();
    }
    ...
    function save(){
        ...
        if ((word == "")) {
            swal({
                type: 'warning',
                title: 'Saving Failed',
                text: 'Joke is required. Please try again.'
            })
        }else{
            if (task == "Add Jokes Responses") {
                add(word);
            }else{
                edit(word);
            }
            ...
            success: function(res){
                if(res == 1){
                    swal({
                        ...
                        text: 'Successfully updated joke',
                        type: 'success'
                    }, function(){
                        location.reload();
                    })
